...
```bash
docker build --target development --no-cache --tag ai-ig-log-frontend:development .
```

Run:

```bash
docker run -p 3000:3000 ai-ig-log-frontend:development
```
...
```bash
docker build --no-cache --tag ai-ig-log-frontend .
```

Run:

```bash
docker run -p 3000:3000 ai-ig-log-frontend
```
